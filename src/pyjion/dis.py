...
class MethodTokens (Enum):
    ...
    METHOD_STORE_SUBSCR_DICT     = 0x00060002
    METHOD_STORE_SUBSCR_DICT_HASH = 0x00060003
    METHOD_STORE_SUBSCR_LIST     = 0x00060004
    METHOD_STORE_SUBSCR_LIST_I   = 0x00060005
    METHOD_STORE_SUBSCR_TUPLE    = 0x00060006

    METHOD_SUBSCR_OBJ           = 0x00070000
    METHOD_SUBSCR_OBJ_I         = 0x00070001
    METHOD_SUBSCR_DICT          = 0x00070002
    METHOD_SUBSCR_DICT_HASH     = 0x00070003
    METHOD_SUBSCR_LIST          = 0x00070004
    METHOD_SUBSCR_LIST_I        = 0x00070005
    METHOD_SUBSCR_TUPLE         = 0x00070006
    METHOD_SUBSCR_TUPLE_I       = 0x00070007
